...
exp.testSeedPrograms = function(data){
    return new Promise(
        async function (fulfill, reject) {
            ...
            eachAsync(
                [
                    {id: '000000000000000000000011', name:'FLL 2017/2018 Slovensko', user:'user1', startDate:new Date(2017,3,10), endDate:new Date(2018,2,20)},
                    {id: '000000000000000000000012', name:'FLL 2018/2019 Slovensko', user:'user1', startDate:new Date(2018,3,9), endDate:new Date(2019,2,20)},
                    {id: '000000000000000000000021', name:'Zenit 2018', user:'user2', startDate:new Date(2018,0,1), endDate:new Date(2018,11,31)},
                    {id: '000000000000000000000022', name:'Zenit 2019', user:'user2', startDate:new Date(2019,0,1), endDate:new Date(2019,11,31)}
                ],
                async function (item, index, done) {
