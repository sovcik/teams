...
exp.testSeedPrograms = function(data){
    return new Promise(
        async function (fulfill, reject) {
            ...
            eachAsync(
                [
                    {id: '000000000000000000000011', name:'FLL '+(y-1)+'/'+y+' Slovensko', user:'user1', startDate:new Date(y-1,3,10), endDate:new Date(y,2,20), message:" Message 11"},
                    {id: '000000000000000000000012', name:'FLL '+y+'/'+(y+1)+' Slovensko', user:'user1', startDate:new Date(y,3,9), endDate:new Date(y+1,2,20), message:" Message 12"},
...
exp.testSeedEvents = function(data){
    return new Promise(
        async function (fulfill, reject) {
            ...
            eachAsync(
                [
                    {progid: '000000000000000000000011', io:'000000000000000000000001', name:'FLL BA '+y, mgr:'user1', startDate:new Date(y,11,5), regEndDate:new Date(y,9,20)},
                    {progid: '000000000000000000000012', io:'000000000000000000000001', name:'FLL BA '+(y-1), user:'user1', startDate:new Date(y-1,11,1), regEndDate:new Date(y-1,9,14)},
                    {progid: '000000000000000000000012', io:'000000000000000000000001', name:'FLL KE '+y, user:'user2', startDate:new Date(y,0,11), regEndDate:new Date(y,9,14)},
                    {progid: '000000000000000000000021', io:'000000000000000000000002', name:'Zenit '+(y-1)+' BA', user:'user3', startDate:new Date(y-1,9,20), regEndDate:new Date(y-1,8,30)},
                    {progid: '000000000000000000000022', io:'000000000000000000000002', name:'Zenit '+y+' BA', user:'user3', startDate:new Date(y,9,21), regEndDate:new Date(y,8,30)}
                ],
                async function (item, index, done) {
        ...
        async function (fulfill, reject) {
            ...
            eachAsync(
                ...
                async function (item, index, done) {
                    ...
                    inv.items = [];
                    inv.items.push({itemNo:1, text:"Template line 1"+index, unit:"pcs", qty:1, unitPrice:1.0, total:1.0});
                    inv.items.push({itemNo:2, text:"Template line 2"+index, unit:"pcs", qty:2, unitPrice:2.0,  total:2.0});
                    ...
                    inv.updateTotal();
                    inv.save();
                    console.log('Invoice template', inv.number, ' id ', inv.id);
