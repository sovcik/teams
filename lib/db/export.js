...
exp.exportProgramData = function(progId, privateData) {
    return new Promise(async function (fulfill, reject) {
        var data = {};
        try {
            log.INFO("Export: program id="+progId+"  privateDate="+privateData);
            ...
            eachAsync(
                ...
                async function(te, idx, next){
                    ...
                    let selectTeamFields = {name:1, "billingOrg.name":1, billingAdr:1};
                    if (privateData)
                        selectTeamFields = {name:1, billingOrg:1, billingAdr:1, billingContact:1, shippingOrg:1, shippingAdr:1, shippingContact:1};
